...
- In `hack.js --money-focus`, genuinely spare RAM may be filled with weaken-only XP after every money target is active and rolling top-ups are healthy. Keep substantial HWGW headroom, and do not use unbatched hack/grow XP jobs against active money targets because they disturb target state and realized income.
